...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'anyme@drmetformin.eu.org',
  ...
  email: 'mailto:anyme@drmetformin.eu.org',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/anymeofu',
    },
  ],
